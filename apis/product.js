...
export default {
    ...
    addUnit:(args)=>{
        ...
        return axios.post(process.env.NEXT_PUBLIC_MERA_WEB+'/api/products/addUnit', {  
             ...args,
    ...
    addProduct:(args)=>{
        ...
        return axios.post(process.env.NEXT_PUBLIC_MERA_WEB+'/api/products/addProduct', {  
             ...args,
             token:localStorage.getItem('token')
         });
     ...
     getProductById:(args)=>{
        ...
        return axios.post(process.env.NEXT_PUBLIC_MERA_WEB+'/api/products/getProductById', {  
             ...args,
             token:localStorage.getItem('token')
         });
    ...
    getProducts:(args)=>{
       ...
       return axios.post(process.env.NEXT_PUBLIC_MERA_WEB+'/api/products/getProducts', {  
            ...args,
            token:localStorage.getItem('token')
        });
    ...
    deleteProduct:(args)=>{
       ...
       return axios.post(process.env.NEXT_PUBLIC_MERA_WEB+'/api/products/deleteProduct', {  
            ...args,
            token:localStorage.getItem('token')
        });
